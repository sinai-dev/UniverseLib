            ...
            switch (next)
            {
                ...
                case Il2CppObjectBase il2CppObjectBase:
                    ...
                    if (nextAsEnumerator != null) // il2cpp IEnumerator also handles CustomYieldInstruction
                        ...
                        Universe.LogWarning($"Unknown coroutine yield object of type '{il2CppObjectBase}' for coroutine '{enumerator}'");
                    return;
                default:
                    Universe.LogWarning($"Unknown coroutine yield object of type '{next}' for coroutine '{enumerator}'");
                    return;
            }
